ActionController::Routing::Routes.draw do |map|
  ...
  map.connect ":resource", :controller => 'lis', :action => 'update', :conditions => { :method => :put }
  ...
  map.connect ":parent/:parent_sourced_id/:resource", :controller => 'lis', :action => 'update', :conditions => { :method => :put }
